...
use \Helpers\Service\IService;


class Service_Exception extends \Exception {}
class Service_InvalidClass_Exception      extends Service_Exception { }
class Service_TooManyParameters_Exception extends Service_Exception { }
class Service_MissingDependency_Exception extends Service_Exception { }
class Service_UndefinedMethod_Exception   extends Service_Exception { }
class Service_InvalidParameters_Exception extends Service_Exception { }
...
class Service implements IService
{
     ...
     *
     * @throws Service_TooManyParameters_Exception
     *
     ...
     *
     * @throws Service_InvalidParameters_Exception
     * @throws Service_UndefinedMethod_Exception
     *
     * @return mixed
     */
    static public function __callStatic($methodname, $arguments)
    {
        ...
        switch ($prefix) {
            case 'def':
                ...
                throw new Service_InvalidParameters_Exception("Invalid call to `$name`");
            case 'ini':
                $count = count($arguments);
                switch ($count) {
                    ...
                    default: throw new Service_InvalidParameters_Exception("Invalid call to `$name`");
                }
                return static::_getDependency($name);
            case 'set':
                if (count($arguments) != 1) throw new Service_InvalidParameters_Exception("Invalid call to `$name`");
        ...
        throw new Service_UndefinedMethod_Exception("Call to undefined method `$methodname`");
    }
    ...
    static protected function _create($classNoNS, $p)
    {
        ...
        throw new Service_TooManyParameters_Exception('Too many constructor parameters');
    }
    ...
    {
        if (!is_object($object)) throw new Service_InvalidParameters_Exception('Dependency must be an object');
     ...
     * @param string $name
     *
     * @throws Service_MissingDependency_Exception
     *
     * @return object
     */
    static protected function _getDependency($name)
    {
        if (!isset(static::$_dependencies[$name])) throw new Service_MissingDependency_Exception("Dependency `$name` not found");
     ...
     * @param string $classNoNS Name of the class, without namespace
     *
     * @throws Service_InvalidClass_Exception
     *
    ...
    static protected function _getClass($classNoNS, $checkIfExists = true)
    {
        ...
        if ($checkIfExists && !class_exists($class)) {
            ...
            throw new Service_InvalidClass_Exception("Unable to find class `$class` [`$classWNS`]");
        }
