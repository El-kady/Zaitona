            ...
            <div class="ui stacked segment left aligned">
                ...
                <div class="field">
                    <div class="ui selection dropdown">
                        <input type="hidden" name="gender" value="<?php echo $this->form()->valueOf("gender",1); ?>">
                        <i class="dropdown icon"></i>
                        <div class="default text"><?php echo $this->text("GENDER"); ?></div>
                        <div class="menu">
                ...
                <div class="field">
                    <div class="ui fluid search selection dropdown">
                        <input name="country" type="hidden" value="<?php echo $this->form()->valueOf("country"); ?>">
                        <i class="dropdown icon"></i>
                        <div class="default text"><?php echo $this->text("COUNTRY"); ?></div>
                        <div class="menu">
