<div class="four wide column">
    <div class="verticalMenu">
        <div class="ui vertical pointing menu fluid">
            <?php foreach (["categories" => ["icon" => "archive", "title" => "CATEGORIES"],"courses" => ["icon" => "book", "title" => "COURSES"],"users" => ["icon" => "users", "title" => "USERS"],"requests" => ["icon" => "pointing up", "title" => "REQUESTS"]] as $controller_key => $menu) { ?>
